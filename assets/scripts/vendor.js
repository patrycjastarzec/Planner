const goalInput = document.getElementById("todaygoal");
const mealInput = document.getElementById("todaymeal");
const toDoInput = document.getElementById("todo");
const appointmentInput = document.getElementById("appointments");
